...
def facemarks_bi_transform(img, roi_box, box_rect, img_path, is_face,
    ...
    save_noface_dir = '/world/data-gpu-94/fenghui/classification/no_face3'
    save_face_dir='/world/data-gpu-94/fenghui/class_face_end/origin/kouzhao_face_18308'
    if is_face:
    ...
    if is_face:
        print('xxxx')
        with open('/world/data-gpu-94/fenghui/class_face_end/origin/kouzhao_face_18308_crop.json', 'a') as f:
            f.write(save_img + ' 1'+'\n')
    else:
        with open('/world/data-gpu-94/fenghui/classification/no_face_data_4_end.json', 'a') as f:
            f.write(save_img + ' 0'+'\n')
            ...
            for inf in infor:
                ...
                if name == '1':
                    try:
                        ...
                        continue
#tpceph_image('/world/data-c9/dl-data/5673875659a518eb6c2af055/5e4bab4931493d4a71028702/15820173535140.4926505191301367_list.json')
...
def kouzhao_face(json_list):
    ...
    with open(json_list, 'r') as f:
        for line in f:
            ...
            tmp_dict = ast.literal_eval(arr[3].strip())
            box = tmp_dict['points']
            xmin = box[0][0] * 1920
            ymin = box[0][1] * 1080
            xmax = box[1][0] * 1920
            ...
            try:
                ...
                continue
kouzhao_face('/world/data-gpu-94/fenghui/class_face_end/origin/kouzhao_face_18308.json')
